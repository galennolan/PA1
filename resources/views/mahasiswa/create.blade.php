...
<body>
    <form enctype="multipart/form-data" class="bg-white shadow-sm p3" action="{{route('mahasiswa.store')}}" method="POST">
    @csrf
    <table bgcolor="aqua" border="0" align="center" width="40%">
    <tr">
    <td colspan="3" align="center"><h2>INPUT DATA MAHASISWA</h2><hr></td>
    </tr>
    <tr>
    <td>NIM</td>
    <td>:</td>
